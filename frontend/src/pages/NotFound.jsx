...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100" data-testid="not-found-page">
      <MarketingNav />
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-5">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative text-center">
          ...
          <h1 className="font-heading text-7xl sm:text-8xl font-bold tracking-tight mt-8 text-white">404</h1>
